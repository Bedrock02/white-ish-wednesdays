...
const  App = () => {
  ...
  return (
    <>
      ...
      <div>
        <iframe style={{ "borderRadius": "12px"}} src="https://open.spotify.com/embed/episode/0Z9BtAnvSURUrkYeQrr5Cw?utm_source=generator" width="100%" height="352" frameBorder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
